...
bg = pygame.image.load('img/bg.jpeg').convert()
game_bg = pygame.image.load('img/bg2.jpg').convert()
scale = pygame.transform.scale(
    game_bg, (450, 900))
bg=pygame.transform.scale(
    bg, (750,940))
main_font = pygame.font.SysFont('impact', 65)
font = pygame.font.SysFont('impact', 45)

title_tetris = main_font.render('TETRIS', True, pygame.Color('#1974D2'))
title_score = font.render('score:', True, pygame.Color('#FF7E00'))
title_record = font.render('record:', True, pygame.Color('#CAE00D'))
